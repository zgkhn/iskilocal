...
const run = async () => {
    console.log(`Scanning Orhaniye (${host})...`);
    // %R78 logic offset is 77
    await scanRegion(1, 'Holding', 77, 2);
    // Let's also check around just in case
    await scanRegion(1, 'Holding', 76, 4);
